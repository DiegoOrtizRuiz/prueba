...
public class ServicioTest {
    ...
    public void unicidadServicioTest() {
        ...
        try {
            ...
            List<VOServicio> lista = alohandes.darVOServicios();
            assertEquals("Debe haber 0 operadores base", 0, lista.size());

            // Lectura de los operadores con un operador adicionado
            VOServicio servicio = alohandes.adicionarServicio("Aseo", 3.0);

            lista = alohandes.darVOServicios();
    ...
    @Test
    public void chequeoServicioTest() {
        // Probar primero la conexión a la base de datos
        try {
        ...
        try {
            ...
            VOServicio servicio = alohandes.adicionarServicio("Aseo", 3.0);
            VOServicio servicio2 = alohandes.adicionarServicio("Aseo", 3.0);
            VOServicio servicio3 = alohandes.adicionarServicio("Aseo2", -3.0);
            assertNull("El tipo no esta entre los permitidos !!", servicio2);
            assertNull("El tipo no esta entre los permitidos !!", servicio2);
    ...
    public void CRDServicioTest() {
        ...
        try {
            ...
            VOServicio servicio2 = alohandes.adicionarServicio("Cocina", 3.0);
            lista = alohandes.darVOServicios();
            assertEquals("Debe haber dos residentes creados !!", 2, lista.size());

            alohandes.eliminarServicioPorId(servicio.getId());
            lista = alohandes.darVOServicios();
            assertEquals("El primer alojamiento adicionado debe estar en la tabla", servicio2.getId(),
                    lista.get(0).getId());
